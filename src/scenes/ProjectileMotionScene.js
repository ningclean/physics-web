...
export class ProjectileMotionScene extends Scene {
  ...
  getControlConfig() {
    return [
      { 
        type: 'range', key: 'v0', label: '初速度 (v0)', min: 10, max: 100, step: 1,
        description: '发射时的速度大小 (m/s)。', resetOnChange: true
      },
      { 
        type: 'range', key: 'theta', label: '发射角度', min: 0, max: 90, step: 1,
        description: '发射方向与水平面的夹角 (度)。', resetOnChange: true
      },
      { 
        type: 'range', key: 'h', label: '初始高度 (h)', min: 0, max: 200, step: 10,
        description: '发射点距离地面的高度 (m)。', resetOnChange: true
      },
      { 
      ...
      { 
        type: 'range', key: 'k', label: '空气阻力 (k)', min: 0.0, max: 1.0, step: 0.01,
        description: '空气阻力系数 (F = -kv)。', resetOnChange: false
      },
      { 
      ...
      { 
        type: 'boolean', key: 'showVel', label: '显示合速度',
        description: '显示合速度矢量。'
      },
      { 
        type: 'boolean', key: 'showComponents', label: '显示分速度',
