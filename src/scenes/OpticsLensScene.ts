...
import { drawLine, drawDot } from '../utils/draw.ts';
import { drawStickFigure, drawEye } from '../utils/graphics.ts';
            ...
            if (extProgress > 0) {
              ...
              if (isConvex) {
                this.drawDashedLine(
                  ...
                  cx,
                  objTopY,
                  cx + (imgX - cx) * extProgress,
                  cy + (imgTopY - cy) * extProgress,
                  rayDashColor
                );
              } else {
                ...
                this.drawDashedLine(
                  ...
                  objTopY,
                  cx + (imgX - cx) * extProgress,
                  objTopY + (imgTopY - objTopY) * extProgress,
                  rayDashColor
                );
              }
              // Ray 3 延长线 (略，避免太乱)
