...
import { drawDot, drawVector, drawLine, drawCircle } from '../utils/draw.ts';
...
interface ElasticCollisionParams {
  m1: number;
  m2: number;
  v1: number;
  v2: number;
  ...
  getControlConfig(): any[] {
    return [
      ...
      },
      {
        ...
        max: 1.0,
        step: 0.1,
        description: '1.0 为完全弹性碰撞，0.0 为完全非弹性碰撞。',
        resetOnChange: false,
      },
      {
        type: 'range',
