import { drawStickFigure, drawBall, drawBlock, drawGround, drawSpring, drawDamper, drawSupport, drawCart, drawPulley, drawRuler, drawProtractor, drawStopwatch, drawMagnet,     drawCharge,
    drawBattery,
    drawLightBulb,
    drawWire,
    drawSwitch,
...
export function renderGraphicsDemo(container) {
    // 1. 清空容器
    container.innerHTML = '';
    ...
    footer.innerHTML = '<p>所有图形均由 <code>src/utils/graphics.js</code> 动态生成。</p>';
